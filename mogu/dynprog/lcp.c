...
static PyMethodDef __pyx_mdef_4mogu_7dynprog_3lcp_1longest_common_prefix = {"longest_common_prefix", (PyCFunction)__pyx_pw_4mogu_7dynprog_3lcp_1longest_common_prefix, METH_VARARGS|METH_KEYWORDS, 0};
 ...
 */
  ...
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(2, 0, 6, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_mogu_dynprog_lcp_pyx, __pyx_n_s_longest_common_prefix, 5, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static int __pyx_pymod_exec_lcp(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init mogu.dynprog.lcp", 0, __pyx_lineno, __pyx_filename);
    }
